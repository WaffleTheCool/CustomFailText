...
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: questui - version: 0.2.0
include $(CLEAR_VARS)
...
include $(CLEAR_VARS)
LOCAL_MODULE := custom-fail-text_0_1_7
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'./extern/libil2cpp/il2cpp/libil2cpp' -DID='"custom-fail-text"' -DVERSION='"0.1.7"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
