...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'C:/Program Files/Unity/Editor/Data/il2cpp/libil2cpp' -DID='"custom-fail-text"' -DVERSION='"0.1.4"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
