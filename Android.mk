...
include $(CLEAR_VARS)
LOCAL_MODULE := custom-fail-text_0_1_6
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'./extern/libil2cpp/il2cpp/libil2cpp' -DID='"custom-fail-text"' -DVERSION='"0.1.6"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
